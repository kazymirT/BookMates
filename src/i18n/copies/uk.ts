export const ukraine = {
  ...
  login: {
    ...
    'is-not-confirm-email': 'Підтвердьте свою електронну пошту перед входом',
    'btn-reset-confirm-email': 'Надіслати лист повторно',
  ...
  'reset-password': {
    ...
    email: 'Електронна пошта',
    error: 'Користувач з такою email незнайдений',
  ...
  'device-code': {
    ...
    placeholder: 'code',
    error: 'Невірний код, спробуйте ще раз або отримайте повторно',
  },
  'book-card': 'Купити',
  price: '{{price}} грн',
  profile: {
  ...
  'forms-error': {
    'password-confirm': 'Пароль не збігається',
    email: {
